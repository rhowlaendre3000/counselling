                                ...
                                <div class="row">
                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                        <div class="r4_counter db_box">
                                            ...
                                            <div class="stats">
                                                ...
                                                <a class="pull-right" href="{{url('all')}}" title="Sign Up"><h4><strong>User Listing</strong></h4></a>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                        <div class="r4_counter db_box">
                                            ...
                                            <div class="stats">
                                                ...
                                                <a class="pull-right" href="{{route('result.create')}}" title="Sign Up"><h4><strong>I.Q Test Results</strong></h4></a>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                        <div class="r4_counter db_box">
                                            ...
                                            <a class="pull-right" href="{{route('schorlastic.create')}}" title="Sign Up"><h4><strong>Educational Information</strong></h4></a>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                        <div class="r4_counter db_box">
                                            ...
                                            <div class="stats">
                                                ...
                                                <a class="pull-right" href="{{route('personality.create')}}" title="Sign Up"><h4><strong>User Personality Information</strong></h4></a>
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-6">
                                        <div class="r4_counter db_box">
                                            ...
                                            <div class="stats">
                                                ...
                                                <a class="pull-right" href="{{route('answer.create')}}" title="Sign Up"><h4><strong>I.Q Test Solutions</strong></h4></a>
