            ...
            <div id="login" class="login loginpage col-lg-offset-4 col-lg-4 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-2 col-xs-8">
                ...
                @csrf
                    ...
                    <p>
                        ...
                        <input type="password" Placeholder ="Enter Your Password" name="password" id="user_pass" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }} input" value="demo" size="20" required></label>
